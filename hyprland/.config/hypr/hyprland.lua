...
hl.bind("SUPER+SHIFT+PERIOD", hl.dsp.window.move({ workspace = "+1" }))
...
-- Layout (Dwindle)
hl.bind("SUPER+MINUS", hl.dsp.window.fullscreen("maximized", "toggle"))
hl.bind("SUPER+CTRL+MINUS", hl.dsp.window.fullscreen("fullscreen", "toggle"))
