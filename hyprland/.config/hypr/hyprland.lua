...
hl.bind("SUPER+W", hl.dsp.focus({ workspace = "-1" }))
...
hl.bind("SUPER+SHIFT+COMMA", hl.dsp.window.move({ workspace = "+1" }))
...
-- Layout (Dwindle)
hl.bind("SUPER+APOSTROPHE", hl.dsp.window.fullscreen("maximized", "toggle"))
hl.bind("SUPER+CTRL+APOSTROPHE", hl.dsp.window.fullscreen("fullscreen", "toggle"))
