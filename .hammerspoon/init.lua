...
local layoutConfig = {
  ...
  _after_ = (function()
    -- Make sure Terminal appears in front of others.
...
-- Key bindings.
--
-- I've used Karabiner-Elements to bind both of the Control keys to
-- Shift+Control+Option+Command (sometimes referred to as "Hyper").
--
-- To find the bundle ID of an app, use:
...
-- Keybindings for switching to specific apps.

local function bindKeyToApp(mod, key, id)
  hs.hotkey.bind(mod, key, (function()
    hs.application.launchOrFocusByBundleID(id)
  end))
end

bindKeyToApp(hyper, 'a', 'com.github.Atom')
bindKeyToApp(hyper, 'f', 'com.apple.finder')
bindKeyToApp(hyper, 'g', 'com.yourcompany.GoldenCheetah')
bindKeyToApp(hyper, 'h', 'com.google.Chrome')
bindKeyToApp(hyper, 'k', 'net.ichi2.anki')
bindKeyToApp(hyper, 'm', 'com.apple.mail')
bindKeyToApp(hyper, 'o', 'com.omnigroup.OmniFocus2')
bindKeyToApp(hyper, 's', 'com.apple.Safari')
bindKeyToApp(hyper, 't', 'com.apple.Terminal')
