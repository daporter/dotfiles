...
(let* ((bg-1 "#040406")                 ; l; 2%
  ...
  (custom-theme-set-faces
   ...
   `(mode-line-inactive    ((t (:inherit mode-line :foreground ,bg+3 :background ,bg+1 :box (:color ,bg+2)))))
   ...
   `(dired-flagged        ((t (:foreground ,magenta :weight bold))))
   `(dired-header         ((t (:foreground ,cyan :weight bold))))
   `(dired-ignored        ((t (:inherit font-lock-comment-face))))
   `(dired-ignored        ((t (:foreground ,blue-bg))))
   ...
   `(org-block-begin-line          ((t (:inherit (fixed-pitch org-meta-line)))))
