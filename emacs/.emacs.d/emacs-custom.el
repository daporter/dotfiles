(custom-set-variables
 ...
 '(package-selected-packages
   '(activities adaptive-wrap agent-shell apheleia avy cape captain
                ...
                csv-mode dape denote disproject editorconfig eglot
                embark embark-consult expand-region flymake
                flymake-hledger flymake-lua flymake-markdownlint
                flymake-yamllint gptel hl-todo hledger-mode
                hyprlang-ts-mode kind-icon ledger-mode ligature
                lorem-ipsum lua-mode magit magit-todos marginalia
                markdown-mode nerd-icons nerd-icons-completion
