(custom-set-variables
 ...
 '(package-selected-packages
   '(agent-shell apheleia auto-compile cape captain casual-suite consult
		 consult-notmuch corfu corfu-prescient csv-mode dape
		 doric-themes eglot embark embark-consult flymake
		 flymake-hledger flymake-lua flymake-markdownlint
		 flymake-yamllint fontaine ghostel hl-todo
		 hledger-mode hyprlang-ts-mode ledger-mode ligature
		 lorem-ipsum lua-mode magit marginalia markdown-mode
		 ...
		 org-modern page-break-lines pcmpl-args pdf-tools
		 popper prescient project python-mode shannon-max
