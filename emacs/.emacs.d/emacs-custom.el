(custom-set-variables
 ...
 '(package-selected-packages
   '(agent-shell apheleia cape captain casual-suite consult
                 consult-notmuch corfu corfu-candidate-overlay
                 corfu-prescient csv-mode dape denote eglot embark
                 embark-consult flymake flymake-hledger flymake-lua
                 flymake-markdownlint flymake-yamllint fontaine
                 ghostel hl-todo hledger-mode hyprlang-ts-mode
                 ledger-mode ligature lorem-ipsum lua-mode magit
                 magit-todos marginalia markdown-mode nerd-icons
                 ...
                 pdf-tools popper prescient project python-mode
