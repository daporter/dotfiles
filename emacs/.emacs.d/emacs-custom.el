(custom-set-variables
 ...
 '(agent-shell-anthropic-default-model-id "Default" nil nil "Customized with use-package agent-shell")
 ...
 '(package-selected-packages
   '(agent-shell apheleia cape captain casual-suite consult corfu
                 corfu-candidate-overlay corfu-prescient csv-mode dape denote
                 eglot embark embark-consult flymake flymake-hledger flymake-lua
                 ...
                 orderless org-anki org-modern org-noter page-break-lines
                 pcmpl-args pdf-tools popper prescient project python-mode
                 shannon-max string-inflection titlecase tramp unfill vertico
